...
select2add();
 function select2add() {
  ...
  content();
  function content() {
    $('#content').load('<?= base_url("jenis/content")?>')
  }
  function data_sampah() {
    $('#content').load('<?= base_url("jenis/data_sampah")?>')
  }



  function add() {
    $('#content').load('<?= base_url("jenis/add")?>');
  }

  function open_edit(id) {
    $('#content').load('<?= base_url("jenis/edit/")?>'+id);

  }

  function open_state(id) {
    $('#content').load('<?= base_url("jenis/state/")?>'+id);
