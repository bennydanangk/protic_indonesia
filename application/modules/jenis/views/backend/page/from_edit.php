							...
							<!-- <form  id="form_add" method="POST" class="form-horizontal" > -->
								<fieldset class="content-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="nama_jenis" value="<?= $data[0]->nama_jenis?>" placeholder="Masukan Nama Jenis" class="form-control" required>
											<input type="hidden" name="id" value="<?= $data[0]->id_jenis?>" placeholder="Masukan Nama Pengguna" class="form-control" required >
