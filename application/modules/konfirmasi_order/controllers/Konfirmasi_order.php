...
function p_delete() {
	...
	$this->M_konfirmasi_order->update_data($where,$data,'t_surat_order');
	$this->M_konfirmasi_order->update_data($where,$data,'iteM_konfirmasi_order');
...
function p_delete_permanen() {
	...
	$this->M_konfirmasi_order->delete_data('t_surat_order',$where);
	$this->M_konfirmasi_order->delete_data('iteM_konfirmasi_order',$where_item);
}
...
function kode_barang()  {
	...
	$kode_ = 'KD';
	$kode_barang = $this->M_konfirmasi_order->CreateCode($kode_);
    echo $kode_barang; 
}
...
function p_add_item() {
	...
	$this->M_konfirmasi_order->insert('iteM_konfirmasi_order',$data);
}
...
function p_delete_item() {
	...
	$where = array(
		'id_iteM_konfirmasi_order' => $id,
		// 'state' => 'tidak'
	);

	$this->M_konfirmasi_order->delete_data('iteM_konfirmasi_order',$where);
}
