<script src="http://parsleyjs.org/dist/parsley.js"></script>
        ...
        <div class="form-group">
            ...
            <input type="hidden" name="url" value="tabel_distributor">
...
foreach ($distributor as $k) {
  ...
  <?php
            ...
            <!-- <input type="text" name="nama_satuan" class="form-control" placeholder="Masukan Nama Satuan" id="nip"   autocomplete="off" required> -->
                 ...
                 <button type="submit"  id="submit_add" class="btn btn-success btn-sm"> <i class="fa fa-search"></i> Cari Distributor</button>
