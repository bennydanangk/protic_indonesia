<script src="http://parsleyjs.org/dist/parsley.js"></script>
        ...
        <div class="form-group">
            <label for="recipient-name" class="col-form-label">Nama Status Barang:</label>
...
foreach ($status_barang as $k) {
  ...
  <?php
            ...
            <!-- <input type="text" name="nama_satuan" class="form-control" placeholder="Masukan Nama Satuan" id="nip"   autocomplete="off" required> -->
                 ...
                 <button type="submit"  id="submit_add" class="btn btn-success btn-sm"> <i class="fa fa-search"></i> Cari Status Barang</button>
