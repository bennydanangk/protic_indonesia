  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/template/') ?>plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css">
          ...
          <div class="form-group">
            ...
            <input type="text" name="kode_id_barang" class="form-control" placeholder="Masukan Nama Ruang/OPD/Kantor" id="kode_id_barang" value="<?= $kode_id_barang;?>"   autocomplete="off"  readonly>
          </div>
        <div class="form-group">
