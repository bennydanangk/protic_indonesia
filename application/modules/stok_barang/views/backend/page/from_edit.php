							...
							<!-- <form  id="form_add" method="POST" class="form-horizontal" > -->
								<fieldset class="content-group">
									...
									<div class="form-group">
										<label class="control-label col-lg-2">Nama stok_barang</label>
										<div class="col-lg-10">
											<input type="text" name="nama_stok_barang" value="<?= $data[0]->nama_stok_barang?>" placeholder="Masukan Nama stok_barang" class="form-control" required>
											<input type="hidden" name="id" value="<?= $data[0]->id_stok_barang?>" placeholder="Masukan Nama Pengguna" class="form-control" required >
