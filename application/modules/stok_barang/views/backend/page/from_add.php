<script src="https://cdn.jsdelivr.net/npm/smultipartjenweetalert2@11"></script>
							...
							<!-- <form  id="form_add" method="POST" class="form-horizontal" > -->
								<fieldset class="content-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="nama_stok_barang" placeholder="Masukan Nama stok_barang" class="form-control" required>
										</div>
									</div>
