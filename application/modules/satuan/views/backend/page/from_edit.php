							...
							<!-- <form  id="form_add" method="POST" class="form-horizontal" > -->
								<fieldset class="content-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="nama_satuan" value="<?= $data[0]->nama_satuan?>" placeholder="Masukan Nama satuan" class="form-control" required>
											<input type="hidden" name="id" value="<?= $data[0]->id_satuan?>" placeholder="Masukan Nama Pengguna" class="form-control" required >
