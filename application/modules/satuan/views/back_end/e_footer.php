...
select2add();
 function select2add() {
  ...
  content();
  function content() {
    $('#content').load('<?= base_url("satuan/content")?>')
  }
  function data_sampah() {
    $('#content').load('<?= base_url("satuan/data_sampah")?>')
  }



  function add() {
    $('#content').load('<?= base_url("satuan/add")?>');
  }

  function open_edit(id) {
    $('#content').load('<?= base_url("satuan/edit/")?>'+id);

  }

  function open_state(id) {
    $('#content').load('<?= base_url("satuan/state/")?>'+id);
