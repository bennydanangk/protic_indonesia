							...
							<!-- <form  id="form_add" method="POST" class="form-horizontal" > -->
								<fieldset class="content-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="nama_distributor" placeholder="Masukan Nama distributor" class="form-control" required>
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="no_wa" placeholder="Masukan Nomor Aktif Whatsapp" class="form-control" required>
										</div>
									</div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="nama_pimpinan" placeholder="Masukan Nama Pimpinan" class="form-control" required>
										</div>
									</div>
