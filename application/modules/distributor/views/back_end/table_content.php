  ...
  <a  class="btn btn-sm btn-secondary" onclick="data_sampah();"> <i class="fa fa-trash"></i> Data Sampah</a> <hr>
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td><?= $k->alamat_distributor?></td>
                      <td><?= $k->no_telp?></td>
                      <td><?= $k->email?></td>
                      <td><?= $k->nama_pimpinan?></td>
                    <td>

                    <a  class="btn btn-sm btn-warning"  onclick='open_edit("<?= $k->id_distributor; ?>");'> <i class="fa fa-edit"></i></a>
                    <a  class="btn btn-sm btn-danger"  onclick='hapus("<?= $k->id_distributor; ?>");'> <i class="fa fa-ban"></i></a>
