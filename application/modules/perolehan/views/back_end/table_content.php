<link rel="stylesheet" href="<?php echo base_url('assets/template/') ?>plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
  ...
  <a  class="btn btn-sm btn-secondary" onclick="data_sampah();"> <i class="fa fa-trash"></i> Data Sampah</a> <hr>
                ...
                <tbody>
                  ...
                  <tr>
                      <td><?= $i; ?></td>
                      <td><?= $k->nama_perolehan?></td>
                    <td>

                    <a  class="btn btn-sm btn-warning"  onclick='open_edit("<?= $k->id_perolehan; ?>");'> <i class="fa fa-edit"></i></a>
                    <a  class="btn btn-sm btn-danger"  onclick='hapus("<?= $k->id_perolehan; ?>");'> <i class="fa fa-ban"></i></a>
