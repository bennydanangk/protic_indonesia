<script src="http://parsleyjs.org/dist/parsley.js"></script>
        ...
        <div class="form-group">
            ...
            <input type="text" name="nama_ruangan" class="form-control" placeholder="Masukan Nama Ruang/OPD/Kantor" id="nip"   autocomplete="off" required>
          </div>
...
<script>
  ...
  $("#form_add").submit(function(e) {
           ...
           e.preventDefault();
         $.ajax({
          url: "<?= base_url('opd_ruangan/add_p')?>",
             type: 'POST',
             data: $(this).serialize(),             
