...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Scane Barcode</title>
        <link href="<?= base_url('assets/template/qr/');?>css/bootstrap.min.css" rel="stylesheet">
        <link href="<?= base_url('assets/template/qr/');?>css/style.css" rel="stylesheet">
    </head>
    <body>
