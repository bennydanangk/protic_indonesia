...
<tr>			
	<td><?= $no;?></td>
									...
									<ul class="icons-list">
												<li onclick="restore_data(<?= $k->id_barang;?>)" class="text-primary-600"><a href="#"><i class="icon-eye"></i> Restore </a></li>
												<li onclick="permanent_hapus_data(<?= $k->id_barang;?>)" class="text-danger-600"><a href="#"><i class="icon-trash"></i> Permanen</a></li>
											</ul>
									</td>
								</tr>
