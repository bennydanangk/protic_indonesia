							...
							<!-- <form  id="form_add" method="POST" class="form-horizontal" > -->
								<fieldset class="content-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
										<input type="hidden" name="id" placeholder="Masukan Nomor Faktur" value="<?= $data[0]->id_faktur;?>" class="form-control" required>

											<input type="text" name="nomor_faktur" value="<?= $data[0]->nomor_faktur;?>"  placeholder="Masukan Nomor Faktur" class="form-control" required>
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<select class="select-search" name="id_distributor" required>
											        <option value="<?= $data[0]->id_distributor;?>" >= <?= $data[0]->nama_distributor;?>=</option>
                                                <?php 
                                    ...
                                    <div class="form-group">
										...
										<div class="col-lg-10">
											<input type="date" value="<?= $data[0]->tgl_faktur;?>"  name="tgl_faktur" placeholder="Masukan Tanggal Faktur" class="form-control" required>
										</div>
									</div>
