								...
								<fieldset class="content-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											...
											<input type="hidden" value="<?= $surat_penawaran[0]->ppn?>" id="ppn_act" name="ppn_act" placeholder="Diskon %" class="form-control" readonly>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="number" id="ppn" name="ppn" placeholder="stok" class="form-control" required readonly>
										</div>
									</div>
