							...
							<!-- <form  id="form_add" method="POST" class="form-horizontal" > -->
								<fieldset class="content-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="nama_customer" value="<?= $data[0]->nama_customer?>" placeholder="Masukan Nama customer" class="form-control" required>
											<input type="hidden" name="id" value="<?= $data[0]->id_customer?>" placeholder="Masukan Nama Pengguna" class="form-control" required >
