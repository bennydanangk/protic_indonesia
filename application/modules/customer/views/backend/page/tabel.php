...
<tr>
									...
									<td>
									<ul class="icons-list">
												<li onclick="open_edit(<?= $k->id_customer;?>)" class="text-primary-600"><a href="#"><i class="icon-pencil7"></i></a></li>
												<li onclick="hapus_data(<?= $k->id_customer;?>)" class="text-danger-600"><a href="#"><i class="icon-trash"></i></a></li>
